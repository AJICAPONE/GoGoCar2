$(document).ready(function () {
    ...
    $('.popup-show-calendar-click').click(function () {
        ...
        var calen_et = $('.calendar-zone-height').offset().top; // Растояние от верха страницы до блока #scroll
        ...
        height = $('.calendar-zone-height').offset().top + $('.calendar-zone-height').height()/2 - calen_h/2;
    ...
    // Modal Covid
    setTimeout(function(){$('#popup-covid,#popup-fp,#popup-go-back,#popup-trip-finish').modal('show');}, 3000);
    ...
    $('.trip-choise-car--count--plus').click(function () {
        if ($(this).prev().children().next().val() != 8) {
    ...
    $('.trip-choise-car--count--minus').click(function () {
        ...
        if ($(this).next().children('.trip-choise-car--count--input').val() < 8 ){
    ...
    $("#add-photo").change(function () {
        ...
        $('.add-photo--info--buttons').html('<div class="gogocar-gray-button m-0-auto-none mr-5">Назад</div><div class="gogocar-yellow-button m-0-auto-none">Сохранить</div>')
    ...
    var chat_go = function() {
        if ($(window).width() < 992) {
            $('.chat-fixed--click').click(function () {
    ...
    $('.chat-content-show--992,.chat-content-user-show-msg').click(function () {
